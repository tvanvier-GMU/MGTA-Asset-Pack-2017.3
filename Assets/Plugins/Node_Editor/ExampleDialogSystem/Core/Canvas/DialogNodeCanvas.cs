...
public class DialogNodeCanvas : NodeCanvas
{
    ...
    /// <summary>
    /// As far as I can tell, this mainly helps in resetting dialogs 
    /// so you can call on it more than once. Why was this separate? Maybe rework it.
    /// </summary>
    /// <param name="dialogIdToLoad"></param>
    /// <param name="goBackToBeginning"></param>
